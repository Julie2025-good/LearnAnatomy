...
// Centralized exercise library (moved to top for initialization order)
const exerciseLibrary = {
  ...
  WallSlide: {
    name: "Wall Slide",
    gif: "https://fitnessprogramer.com/wp-content/uploads/2021/02/wall-slide.gif",
    gifAlt: "Wall slide"
  },
  TricepsPushdown: {
  ...
  Lunge: {
    name: "Lunge",
    gif: "https://fitnessprogramer.com/wp-content/uploads/2023/10/Static-Lunge.gif",
  ...
  StandingHipFlexionExternalRotation: {
  ...
  SideLyingExternalRotation: {
    ...
    gif: "https://fitnessprogramer.com/wp-content/uploads/2021/09/Dumbbell-Lying-External-Shoulder-Rotation.gif",
  ...
  SidePlank: {
    name: "Side Plank",
    gif: "https://fitnessprogramer.com/wp-content/uploads/2021/02/Side-Plank-1.png",
    gifAlt: "Side plank exercise"
  },
  Squat: {
    name: "Squat",
    gif: "https://fitnessprogramer.com/wp-content/uploads/2021/02/BODYWEIGHT-SUMO-SQUAT.gif",
  ...
  StandingCalfRaise: {
    ...
    gif: "https://fitnessprogramer.com/wp-content/uploads/2021/06/Standing-Calf-Raise.gif",
  ...
  BicycleCrunch: {
    name: "Bicycle Crunch",
    gif: "https://fitnessprogramer.com/wp-content/uploads/2021/02/Bicycle-Crunch.gif",
  ...
  BandExternalRotation: {
    ...
    gif: "https://fitnessprogramer.com/wp-content/uploads/2023/06/Banded-Shoulder-External-Rotation.gif",
...
const muscles = {
  ...
  exercises: [exerciseLibrary.PushUp, exerciseLibrary.BarbellBenchPress]
  },
  deltoid: {
    name: "Deltoid",
  ...
  exercises: [exerciseLibrary.DumbbellLateralRaise, exerciseLibrary.ShoulderPress]
  },
  latissimus_dorsi: {
  ...
  exercises: [exerciseLibrary.PullUp, exerciseLibrary.LatPulldown]
  },
  trapezius: {
    name: "Trapezius",
  ...
  exercises: [exerciseLibrary.BarbellShrug, exerciseLibrary.FacePull]
  },
  rhomboid: {
    name: "Rhomboid",
  ...
  exercises: [exerciseLibrary.ReverseFly, exerciseLibrary.SeatedRow]
  },
  levator_scapulae: {
  ...
  exercises: [exerciseLibrary.DumbbellShrug, exerciseLibrary.NeckStretch]
  },
  pectoralis_minor: {
  ...
  exercises: [exerciseLibrary.PushUpPlus, exerciseLibrary.ChestDip]
  },
  serratus_anterior: {
  ...
  exercises: [exerciseLibrary.PushUpPlus, exerciseLibrary.WallSlide]
  },
  triceps_brachii: {
  ...
  exercises: [exerciseLibrary.TricepsPushdown, exerciseLibrary.OverheadTricepsExtension]
  },
  brachialis: {
    name: "Brachialis",
  ...
  exercises: [exerciseLibrary.HammerCurl, exerciseLibrary.ReverseCurl]
  },
  biceps_brachii: {
    name: "Biceps Brachii",
  ...
  exercises: [exerciseLibrary.BicepsCurl, exerciseLibrary.ChinUp]
  },
  iliacus_hf: {
    name: "Iliacus (HF)",
  ...
  exercises: [exerciseLibrary.StandingHipFlexion, exerciseLibrary.Lunge]
  },
  psoas_major_hf: {
    name: "Psoas Major (HF)",
    ...
    joint: "Hip",
    movement: "Flexes the hip.",
  exercises: [exerciseLibrary.LegRaise, exerciseLibrary.MountainClimber]
  },
  sartorius_ba_hf: {
  ...
  exercises: [exerciseLibrary.StandingHipFlexionExternalRotation, exerciseLibrary.SeatedButterflyStretch]
  },
  ...
  gluteus_maximus_he: {
    ...
    exercises: [exerciseLibrary.Squat]
  },
  vastus_medialis_q2: {
    ...
    translation: "股内侧肌（Q2）",
    memoryAid: "Teardrop-shaped muscle on inner thigh. To remember the name: 'Medialis' means toward the midline.",
    ...
    exercises: [exerciseLibrary.Squat, exerciseLibrary.LegExtension]
  },
  vastus_lateralis_q3: {
  ...
  vastus_intermedius_q4: {
    ...
    joint: "Knee",
    movement: "Extends the knee.",
  exercises: [exerciseLibrary.LegExtension, exerciseLibrary.Squat]
  },
  hamstrings: {
    name: "Hamstrings",
    ...
    exercises: [exerciseLibrary.RomanianDeadlift, exerciseLibrary.LyingLegCurl]
  },
  biceps_femoris_h1: {
    ...
    joint: "Hip, Knee",
    movement: "Extends the hip and flexes the knee.",
    exercises: [exerciseLibrary.LyingLegCurl]
  },
  semitendinosus_h2: {
  ...
  gastrocnemius_c1: {
    ...
    exercises: [exerciseLibrary.StandingCalfRaise, exerciseLibrary.SeatedCalfRaise]
  },
  soleus_c2: {
    name: "Soleus (C2)",
  ...
  exercises: [exerciseLibrary.ToeRaise, exerciseLibrary.HeelWalk]
  },
  rectus_abdominis: {
    ...
    exercises: [exerciseLibrary.Crunch, exerciseLibrary.LegRaise]
  },
  transversus_abdominis: {
    ...
    exercises: [exerciseLibrary.Plank, exerciseLibrary.DeadBug]
  },
  internal_oblique: {
  ...
  exercises: [exerciseLibrary.RussianTwist, exerciseLibrary.SidePlank]
  },
  external_oblique: {
    ...
    joint: "Spine",
    movement: "Flexes and rotates the spine; compresses abdominal contents.",
    exercises: [exerciseLibrary.BicycleCrunch, exerciseLibrary.StandingObliqueCrunch]
  },
  erector_spinae: {
    name: "Erector Spinae",
    ...
    exercises: [exerciseLibrary.BackExtension]
  },
  ...
  infraspinatus_r2: {
    ...
    exercises: [
        ...
        exerciseLibrary.BandExternalRotation
    ]
  },
  teres_minor_r3: {
    name: "Teres Minor (R3)",
  ...
  subscapularis_r4: {
    ...
    exercises: [
    exerciseLibrary.BandInternalRotation
    ]
  },
  piriformis: {
    name: "Piriformis",
    ...
    exercises: [
    exerciseLibrary.SeatedPiriformisStretch,
    exerciseLibrary.Figure4Stretch
    ]
  },
  brachioradialis: {
    ...
    movement: "Flexes the elbow.",
    exercises: [
    exerciseLibrary.HammerCurl,
    exerciseLibrary.ReverseCurl
    ]
  },
  gluteus_medius_he: {
    name: "Gluteus Medius",
  ...
  gluteus_minimus_he: {
    ...
    movement: "Abducts and medially rotates the hip.",
    exercises: [
    exerciseLibrary.Clamshell,
    exerciseLibrary.SideLyingLegRaise
    ]
  },
  tensor_fascia_latae_ba_abd: {
    ...
    exerciseLibrary.SideStepWithBand
    ]
  },
  adductor_group_5: {
    name: "Adductor Group",
  ...
  sternocleidomastoid: {
    ...
    multifidus: {
      name: "Multifidus",
      image: "https://www.kenhub.com/thumbor/4QwKJQwQwQwQwQwQwQwQwQwQwQw=/fit-in/680x680/filters:fill(FFFFFF,true)/images/learnable/multifidus-muscle/multifidus-muscle.png",
      imageAlt: "Multifidus muscle anatomy",
      audio: getAudioUrl("Multifidus"),
      translation: "多裂肌",
      memoryAid: "Deep back stabilizer, runs along the spine. 'Multi' means many, 'fidus' means split—many split fibers.",
      origin: "Sacrum, iliac crest, transverse processes of lumbar, thoracic, and cervical vertebrae.",
      insertion: "Spinous processes of vertebrae above (2-4 segments superior).",
      joint: "Spine",
      movement: "Stabilizes vertebrae during local movements of vertebral column.",
      exercises: [
        exerciseLibrary.Plank,
        exerciseLibrary.DeadBug
      ]
    },
    quadratus_lumborum: {
      name: "Quadratus Lumborum",
      image: "https://www.kenhub.com/thumbor/4QwKJQwQwQwQwQwQwQwQwQwQwQw=/fit-in/680x680/filters:fill(FFFFFF,true)/images/learnable/quadratus-lumborum-muscle/quadratus-lumborum-muscle.png",
      imageAlt: "Quadratus Lumborum muscle anatomy",
      audio: getAudioUrl("Quadratus Lumborum"),
      translation: "腰方肌",
      memoryAid: "Square-shaped muscle in lower back. 'Quadratus' means square, 'lumborum' refers to lumbar region.",
      origin: "Iliac crest and iliolumbar ligament.",
      insertion: "12th rib and transverse processes of L1-L4.",
      joint: "Lumbar spine",
      movement: "Lateral flexion of vertebral column, fixes 12th rib during inspiration.",
      exercises: [
        exerciseLibrary.SidePlank,
        exerciseLibrary.RussianTwist
      ]
    },
    diaphragm: {
      name: "Diaphragm",
      image: "https://www.kenhub.com/thumbor/4QwKJQwQwQwQwQwQwQwQwQwQwQw=/fit-in/680x680/filters:fill(FFFFFF,true)/images/learnable/diaphragm-muscle/diaphragm-muscle.png",
      imageAlt: "Diaphragm muscle anatomy",
      audio: getAudioUrl("Diaphragm"),
      translation: "膈肌",
      memoryAid: "Main muscle of breathing, dome-shaped under the lungs.",
...
function loadMuscle(muscleKey) {
  console.log('Clicked muscle:', muscleKey);
  const m = muscles[muscleKey];
  if (!m) {
    console.warn('Muscle not found:', muscleKey);
    document.getElementById('main-content').innerHTML = `<div style='color:red'>Muscle not found: ${muscleKey}</div>`;
    return;
  }
...
document.addEventListener('DOMContentLoaded', function() {
  document.querySelectorAll('.muscle-list li').forEach(li => {
    li.onclick = function() {
      console.log('Sidebar clicked:', this.dataset.muscle);
